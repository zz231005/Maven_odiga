...
public class CommentAnoController {
	...
	@ResponseBody
	@RequestMapping(value = "/comment_write.do") // 포스트방식일때는 여기로
	...
	@ResponseBody
	@RequestMapping(value = "/comment_delete.do", method = RequestMethod.POST) // 포스트방식일때는 여기로
	...
	@ResponseBody
	@RequestMapping(value = "/comment_update.do", method = RequestMethod.POST) // 포스트방식일때는 여기로
